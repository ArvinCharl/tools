    ...
    for each_dir in data_dir_list:
        ...
        for i in range(cut_factor_row):
            for j in range(cut_factor_clo):
                ...
                src_path = r'L19/P0019_1_5549_L19.png'  # 带地理影像
...
def combine(data_dir, w, h, c, out_dir, out_type='tif', file_type=['tif', 'tiff']):
    ...
    for key in dir_dict.keys():
        ...
        src_path = r'L19/P0019_1_5549_L19.png'  # 带地理坐标影像
...
if __name__ == '__main__':
    ##### cut
    data_dir = r'L19'
    out_dir = r'out_cut_L19'
    file_type = ['tif', 'png']
    out_type = 'tif'
    cut_size = 512
    cut(data_dir, out_dir, file_type, out_type, cut_size)
    ##### combine
    # data_dir = r'out_cut_L18'
    # h = 9216
    # w = 11264
    # c = 3
    # out_dir = r'out_combine_L18'
    # out_type = 'tif'
    # file_type = ['tif']
